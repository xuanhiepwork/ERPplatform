import { MoreVertical, Share2, Copy, Trash2, Eye, Download, CheckCircle, Clock, FileText } from 'lucide-react';
import { Card, CardContent } from '../../../../components/ui/card';
import { Badge } from '../../../../components/ui/badge';
import { Button } from '../../../../components/ui/button';
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuSeparator, DropdownMenuTrigger } from '../../../../components/ui/dropdown-menu';
import { assetTypeConfig } from '../../../../mocks/dam/damMocks';
            ...
            <Card>
                <CardContent className="p-0">
                    <div className="divide-y divide-border">
                        {assets.map((asset) => {
                            const AssetIcon = assetTypeConfig[asset.type]?.icon || FileText;
                            return (
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {assets.map((asset) => {
                ...
                const AssetIcon = typeConfig?.icon || FileText;
