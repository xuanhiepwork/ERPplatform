...
import { Search, Bell, ChevronDown, Crown, AlertTriangle, Settings, LogOut, CheckCircle } from 'lucide-react';
...
export function FounderHeader() {
  ...
  const handleLogout = () => {
    authApi.logout(); // Xóa token & user khỏi localStorage
    setUserRole('Employee'); // Reset state phân quyền về mặc định
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-64 bg-slate-900 border-slate-700">
            ...
            <DropdownMenuItem
              ...
              onClick={() => navigate('/settings')} // route
            >
