...
export function KPICards({ cashBalance, revenue, expenses, pendingCount, pendingTotal }: KPICardsProps) {
    return (
        <div className="grid grid-cols-4 gap-4">
            ...
            <Card className="bg-white rounded-lg border shadow-sm p-6">
                ...
                <div className="text-3xl font-bold text-gray-900">{expenses}</div>
