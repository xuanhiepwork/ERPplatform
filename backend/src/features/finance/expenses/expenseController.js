...
exports.createExpenseClaim = catchAsync(async (req, res, next) => {
    ...
    // Use a short 'Pending' status to avoid potential DB column length issues in
    // development environments. The payables query uses LIKE 'Pending%' so this
    // remains compatible with approval flows.
